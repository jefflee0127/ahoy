...
<html>
  ...
  <script>
    function getNotif(id, alertarea) {
      ...
      var info="id="+id;
      hr.open("POST", "http://nardis.dothome.co.kr/nardis_core/notif_load_private.php", true);
    ...
    function getUrl(box, url_input) {
          ...
          var info="link="+link;
          //console.log(info);
          hr2.open("POST", "http://nardis.dothome.co.kr/nardis_core/comment_load_private.php", true);
      ...
      function getUrl2(box, url_input) {
            ...
            var info="link="+link;
            //console.log(info);
            hr3.open("POST", "http://nardis.dothome.co.kr/nardis_core/comment_load_private.php", true);
